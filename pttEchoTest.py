...
def parse_args():
    ...
    parser.add_argument('--use_openai', action='store_true', help='Use OpenAI for AI response')
...
def main():
    ...
    # Set up API configuration based on user choice
    if choice == '1':
        import openai
        api_key = os.getenv('OPENAI_API_KEY')
        if not api_key:
            print("\n[CONFIG] OpenAI API key not found in environment.")
